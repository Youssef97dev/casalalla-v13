        ...
        <div className="fixed inset-0 bg-[black]/60 z-[999] overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen px-0 lg:px-4">
            ...
            >
              ...
              >
                <div className="flex bg-[#efe2bd] items-center justify-end px-5 py-3 border-b border-white">
                  <button
                    type="button"
                ...
                <div className="py-10 px-0 bg-[#efe2bd] w-full flex justify-center items-center">
                  <Reserve />
                </div>
              </DialogPanel>
            </TransitionChild>
